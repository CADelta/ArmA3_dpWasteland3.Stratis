//////////////////////////////////////////////////////////////////////////////////////////////////////////////
//	@file Name: IgiLoad.sqf																					//
//	@file Version: IgiLoad v0.9.9																							//
//	@file Author: Igi_PL, [CAD] Krycek																			//
//																											//
...
if (isNil "IL_Variables") then
{
	...
	IL_Supported_Veh_Ammo = ["Box_NATO_AmmoVeh_F", "Box_East_AmmoVeh_F", "Box_IND_AmmoVeh_F", "Land_CargoBox_V1_F", "Land_Pallet_MilBoxes_F", "Land_Sacks_goods_F"];	// "Land_Pallet_MilBoxes_F" and "Land_Sacks_goods_F" was added by CAD!
		...
		{
			{
				...
				else
				{
					...
					if ((_box_num > _slot_num) && !_done) then
					{
						...
						R3F_LOG_joueur_deplace_objet = objNull;					// This releases the object from the Moveable feature from R3F
						_x setVariable ["R3F_LOG_disabled", true];		// This disables any R3F functionality while the object is loaded. Look for a counterpart for when the object gets unloaded again.
		...
		{
			{
				...
				if (_x getVariable "doors" == _doors) then
				{
					...
					if (((_x getVariable "attachedTruck") == _v) && ((_x getVariable "attachedPos") == (_counter)) && (_counter < 0) && !_done) then
					{
						...
						_x setVariable ["R3F_LOG_disabled", false];		// This re-enables R3F functionality.
