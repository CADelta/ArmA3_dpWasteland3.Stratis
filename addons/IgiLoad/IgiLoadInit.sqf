...
//cutText ["IgiLoad is loading. Please wait...","PLAIN",2];				// Do not want to show this in Wasteland.
sleep (random 30);

//cutText [Format ["IgiLoad init Player: %1", Player],"PLAIN",2];		// Do not want to show this in Wasteland.
...
//cutText ["IgiLoad loaded. Have fun :)","PLAIN",2];					// Do not want to show this in Wasteland.
