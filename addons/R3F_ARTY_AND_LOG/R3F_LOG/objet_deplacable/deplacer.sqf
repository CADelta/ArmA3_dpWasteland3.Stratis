...
else
{
	...
	else
	{
		...
		else
		{
			...
			_action_menu_release_relative = player addAction [("<img image='client\ui\r3f\r3f_release.paa'/> <t color='#06ef00'>" + STR_R3F_LOG_action_relacher_objet + "</t>"), "addons\R3F_ARTY_AND_LOG\R3F_LOG\objet_deplacable\relacher.sqf", false, 5, true, true];
			_action_menu_release_horizontal = player addAction [("<img image='client\ui\r3f\r3f_releaseh.paa'/> <t color='#06ef00'>" + STR_RELEASE_HORIZONTAL + "</t>"), "addons\R3F_ARTY_AND_LOG\R3F_LOG\objet_deplacable\relacher.sqf", true, 5, true, true];
			_action_menu_45 = player addAction [("<img image='client\ui\r3f\r3f_rotate_45.paa'/> <t color='#dddd00'>Rotate object 45?</t>"), "addons\R3F_ARTY_AND_LOG\R3F_LOG\objet_deplacable\rotate.sqf", 45, 5, true, true];
