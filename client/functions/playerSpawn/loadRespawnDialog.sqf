...
private ["_display","_respawnText","_missionUptimeText","_side","_dynamicControlsArray","_button","_friendlyTowns","_friendlyCount","_enemyCount","_tempArray","_timeText","_name","_text", "_players", "_playerArray"];
...
while {respawnDialogActive} do
{
    ...
    if ((count units group player > 1) && (_side == "Independent")) then
    {
        _tempArray = [];
        {
